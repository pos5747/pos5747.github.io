...
::: callout-note
I continue to revise this project. While the important pieces of the project (i.e., overall expectations and deadlines) will not change without advance warning, I hope to continuously clarify this document in light of conversation with students about their projects.
:::
...
I view answers to the first question---a description of the world as it exists---as a difficult and worthwhile challenge. It seems difficult to even entertain the second and third questions without a thorough understanding of the world as it exists.
...
The several assignments do not increase the amount of work. Instead, they help you *distribute the work* more evenly across the semester. These assignments give you time to reflect, revise, and improve each part of your project. They make the final result stronger and less stressful to produce. It also gives me time to give you feedback early and often.

## Optional Early Assignments

-   **Descriptive Research in Your Field** *(Optional; due by Sep. 1)* Reflect on what descriptive research looks like in your field and identify examples of high-quality description. Consider the following prompts as starting points:
...
-   **Data Sets** *(Optional; due by Sep. 8)* Identify publicly available data sets relevant to your general area of interest. For each data set, briefly describe the variables, cases, and time periods included. Flag any variables that seem especially important. Realize there is lots of data available---search deep and wide! And talk to other students and faculty.
-   **Concepts** *(Optional; due by Sep. 15)* Explore and explain the major theoretical or empirical concepts scholars focus on in your area.
-   **Narrowing Your Topics** *(Optional; due by Sep. 22)* Narrow your focus by choosing a few concepts you find interesting. Identify FSU faculty working in these areas. Sketch 3–5 potential research questions.

## Required Assignments

The percentages below are shares of the course grade; together they make up the research paper's 35%.

-   **Prospectus** *([Required]{.text-warning}; 5%; due by Sep. 29)* A memo describing your project in as much detail as possible. This should resemble the structure of a paper, though it will still be an early, developing version. At a minimum, the prospectus should: (1) clearly state the descriptive claim or question; (2) explain why the claim is important, independent of any causal links between the focal variables; (3) demonstrate the feasibility of the data collection (e.g., collected 20% or ideally all of the data); and include an initial data analysis (scatterplots and averages might be sufficient). *Instructor comments, ASAP.*
-   **First Draft** *([Required]{.text-warning}; 5%; due by Oct. 20)* Submit the first full draft of your paper. This should include a working version of all major sections, figures, and tables. Also email the PDF to your assigned reviewer. *Feedback from a peer, ASAP*.
-   **Peer Review** *([Required]{.text-warning}; 5%; due by Oct. 27)* Provide comments on your assigned colleague's first draft. When providing feedback on colleagues' work, I like the RAP model [here](https://milnepublishing.geneseo.edu/medical-writing/chapter/20-how-to-give-good-feedback-on-colleagues-drafts/). Most importantly, in this model, "focus time and effort on the *highest points of leverage* for improving the document." The goal is to make suggestions that improve the final product at the end of the semester. In addition to other comments, please make sure to provide feedback on these three items: (1) Does the paper make a clear *descriptive* claim? It might be helpful to review the key readings on descriptive research above, such as @gerring2012, @holmes2024, and @dekadt2025. (2) Does the paper make a compelling empirical argument for that descriptive claim? (3) Does the paper clearly explain the substantive/theoretical/normative importance of that descriptive claim? It's important that the defense not rely on any assumed/implied *causal* relationship among the variables.
-   **Second Draft** *([Required]{.text-warning}; 5%; due by Nov. 24)* Submit a substantially revised draft of your paper that incorporates peer feedback. *Instructor comments ASAP*.
-   **Poster Presentation** *([Required]{.text-warning}; 5%; Dec. 1, 9:45--11:30 AM, 5th floor of Bellamy---there is no class meeting that day)* Present your research in a short, conference-style poster session. This is a low-stakes chance to get feedback and practice communicating your work.
-   **Final Project** *([Required]{.text-warning}; 10%; due by Dec. 8)* Submit the final version of your research paper. You must submit a PDF of the final version of the paper and the data and computer code to reproduce your work. This version should reflect feedback from both the poster session and instructor comments. This version should be *polished*.

[^2]: See also Part II of Gerring's *Social Science Methodology* for a supplement to Gerring (2012).
...
[^5]: Some folks like Overleaf's implementation.
