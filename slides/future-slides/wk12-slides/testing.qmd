...
-   Important consequences for *you*. You want to conduct studies that allow you to make meaningful claims at the end. (After all, they take hundreds of hours!)
...
**Important**: Failure to reject $H_0$ means *ambiguous evidence*, not evidence that $H_0$ is true.
...
"The probability of obtaining data *more extreme* than the data we actually obtained if the null hypothesis were true."
...
-   If we set $m^* = L$, then $[L, \infty)$ is a 95% *one-sided* confidence interval.
...
-   Find 95% *one-sided* confidence interval $(-\infty, U]$.
...
Only make a claim if the claim holds for the *entire* confidence interval.
:::
...
I like to say: "Only make a claim if the claim holds for the *entire* confidence interval." Using the arguments from @rainey2014 and @mccaskey2015, give two examples of how current practice deviates from this advice. Explain why these deviations matter. Explain a how my advice applies to these two sitations.

Examples:

1.  @mccaskey2015: Claiming "substantively significant" if the point estimate is meaningful (and statistically significant).
...
-   We need to reject *both* null hypotheses.
...
-   The chance that you are wasting your time is non-trivial.
...
::: aside
In talks, you might have heard me ask about the scale of the estimates. I usually ask how an estimate should be interpreted. But I'm looking at *the SE* when I ask that question, because I'm constructing this picture in my mind---I want to know how the SE compares to $m$.
:::
