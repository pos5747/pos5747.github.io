...
1. Normal linear
1. Logit
1. Multinomial Logit (see my slides)
1. Ordered Logit (see my slides)
...
I like to say: "Only make a claim if the claim holds for the entire confidence interval.” 
